...
from networks.hymamba import build_hybird
...
#    pretrained_pth = os.path.join(pretrained_dir, model_name)
    pretrained_pth = '/mnt/sda/pai-hdd/bknian/UNETR/runs/unetr_test/model_final_st.pt'
...
#        )
        model = build_hybird(in_channel=args.in_channels, n_classes=args.out_channels, img_size=args.roi_x)
        
        model_dict = torch.load(pretrained_pth)
#        torch.save(model_dict["state_dict"],'/mnt/sda/pai-hdd/bknian/UNETR/runs/unetr_test/model_final_st.pt')
#        exit()
